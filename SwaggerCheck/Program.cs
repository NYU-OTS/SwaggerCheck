...
namespace SwaggerCheck
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            var swaggerCheck = serviceProvider.GetService<SwaggerCheck>();
            swaggerCheck.Run(args);
        ...
        class SwaggerCheck
        {
            ...
            public SwaggerCheck(ILoggerFactory loggerFactory)
            {
                _logger = loggerFactory.CreateLogger<SwaggerCheck>();
            }
            ...
            public void Run(string[] args)
            {
                ...
                var verboseOption = app.Option("-v|--verbose",
                    "Verbose output about mismatches",
